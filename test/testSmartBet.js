...
contract("SmartBet", async (accounts) => {
    ...
    it("#getMatch(_matchId) should throw error if match ID does not exist", async() => {
        await createTestMatch(1);
    ...
    it("#getSmartAsset(_smartAssetId) should throw error if asset is invalid", async() => {
        await createTestMatch(1);
    ...
    it("#getSmartAsset(_smartAssetId) should only allow asset owner view asset details", async() => {
        await createTestMatch(1);
    ...
    it("#getSmartAsset(_smartAssetId) should correct asset details", async() => {
        let resultBetOn = SmartBet.enums.MatchResult.TEAM_A_WON;
        let oddsTeamA = 4;
        let bettor1Stake = generateValue(1);
        let expectedAssetValue = bettor1Stake.mul(new BN(oddsTeamA));
